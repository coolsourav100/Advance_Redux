...
const respence = await fetch('https://etshapreact-default-rtdb.asia-southeast1.firebasedatabase.app/CartData.json')
...
export const sendCartData=(cart)=>{
  return async(dispatch)=>{
   ...
   const responce = await fetch('https://etshapreact-default-rtdb.asia-southeast1.firebasedatabase.app/CartData.json',{
     method:'PUT',
